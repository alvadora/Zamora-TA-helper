...
catalyst_list = ['emerald essence','strength essence','magic essence','time essence','stamina essence',
                 'life crystal','wind crystal','star crystal', 'soul crystal','aura crystal',
                 'piece of courage','dexterity stone','freedom stone','crimson stone','potent ruby','dream ruby','moon element',
                 'soul orb','wealth orb','demon orb','starlight crystal','lambent crystal','ice crystal','evil hammer','moon flower']
...
mats = [
    ...
    {'cruel remnant':{}},
    {'maple worlds energy':{}},
    {'kalos residual determination':{}},
    {'onyx secondary':{}},
    {'black mage remnnant':{}},
    {'damaged black heart':{}},
    {'superior lidium heart':{}},
    {'miraculous chaos scroll 50%':{}},
    ...
    {'absolab weapon':{'wrath':8,
                      ...
                      'twisted time':9000,
                      'sealed wiseman stone':5,
                       'sealed warrior stone':5,
                       'sealed saint stone':5}},
    ...
    {'arcane weapon':{'cruel remnant':12,
                      'void fragment':3,
                      'lust':3,
                      'grand spell essence':100,
                      'scroll of secrets':10,
                      'condensed crystal':180,
                      'moon rock':180,
                      'star rock':180,
                      'primal essence':150,
                      'philosopher stone':200,
                      'twisted time':30000,
    ...
    {'arcane hat':{'greed':6,
                   ...
                   'corresponding absolab hat':1}},
  
    {'arcane overall':{'void fragment':8,
                   'grand spell essence':90,
                   'scroll of secrets':8,
                   'condensed crystal':150,
                   'moon rock':150,
                   ...
                   'sealed warrior stone':9,
                   'sealed saint stone':9,
                   'corresponding absolab shoulder':1}},

    {'arcane shoulder':{'greed':8,
                   'grand spell essence':90,
                   'scroll of secrets':8,
    ...
    {'genesis weapon':{'wrath':8,
                       ...
                       'greed':8,
                       'cruel remnant':8,
                       'black mage remnant':6,
                       'grand spell essence':150,
                       'scroll of secrets':15,
                       'condensed crystal':250,
                       'moon rock':250,
                       'star rock':250,
                       ...
                       'twisted time':60000,
                       'sealed wiseman stone':15,
                       'sealed warrior stone':15,
                       'sealed saint stone':15}},
    ...
    {'freedom stone':{'condensed crystal':5,
                      'confusion fragment':50,
                      'wind crystal':2,
                      'black scroll (level 3)':5,
                      'soul elixir':50}},

    {'crimson stone':{'moon rock':10,
                      'star rock':10,
                      'star crystal':2,
                      'black scroll (level 3)':5,
    ...
    {'starlight crystal':{'life crystal':2,
                          'black scroll (level 3)':5,
                          'brilliant dusk essence':5,
                          'soul elixir':50}},

    {'lambent crystal':{'soul crystal':2,
                        'black scroll (level 3)':5,
                        'soul elixir':50,
                        'moon rock':5}},

    {'ice crystal':{'aura crystal':2,
                    'black scroll (level 3)':5,
                    'soul elixir':50,
                    'condensed crystal':5}},
